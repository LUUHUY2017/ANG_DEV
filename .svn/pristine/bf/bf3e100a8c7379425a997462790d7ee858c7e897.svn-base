...
// Routing
import { FbaMetricsComparisonRoutingModule } from './fba-metrics-comparison-routing.module';
import { FbaMetricsComparisonComponent } from './fba-metrics-comparison.component';
