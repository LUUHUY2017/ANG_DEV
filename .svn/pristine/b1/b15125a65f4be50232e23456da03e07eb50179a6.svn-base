...
// Routing
import { ImportDataInOutRoutingModule } from './import_data_in_out-routing.module';
import { ImportDataInOutComponent } from './import_data_in_out.component';
// Ng2-select
...
@NgModule({
  ...
  declarations: [
    ImportDataInOutComponent,
  ],
  providers: [AppService],
})
export class ImportDataInOutModule {
  constructor() { }
}
