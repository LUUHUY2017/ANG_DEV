...
// Routing
import { FootfallTimeTrendRoutingModule } from './time-trend-rounting.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallTimeTrendRoutingModule,
  ...
  declarations: [
    FootfallTimeTrendComponent,
    // pickuplocationcomponent
   // DataFilterPipe,
  ]
})
export class FootfallTimeTrendModule { }
