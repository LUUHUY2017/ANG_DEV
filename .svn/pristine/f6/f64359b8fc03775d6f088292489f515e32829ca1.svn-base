export const language = {
    ...
    tiep_theo: 'Tiếp theo',
    khong_the_ket_noi_may_chu: 'Không thể kết nối máy chủ. Vui lòng thử lại',
    ...
    Hien_thi_mat_khau: 'Hiển thị mật khẩu',
};
