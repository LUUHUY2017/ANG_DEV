...
// Routing
import { TerminalUserMailComponent } from './terminalusermail.component';
import { TerminalUserMailRoutingModule } from './terminalusermail-routing.module';
// Ng2-select
...
@NgModule({
    ...
    declarations: [
        TerminalUserMailComponent
    ],
    providers: [AppService],
    exports: [ModalModule]
})
export class TerminalUserMailModule {
    constructor() { }
}
