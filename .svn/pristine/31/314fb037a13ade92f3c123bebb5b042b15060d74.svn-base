...
@Component({
    templateUrl: 'reporting-stores.component.html',
    styleUrls: ['reporting-stores.component.scss']
})

export class FootfallReportingStoresComponent implements OnInit {
    @ViewChild(StoreReportingFFScheduleComponent) scheduleComponent: StoreReportingFFScheduleComponent;
    defaultModule = 4;
    indexViewBy: number;
    currentPageId = environment.Pages.footfall.performance_reporting_stores;
    ...
    end_date: any;
    time_value = '';
    public page_id = environment.Pages.footfall.performance_reporting_stores;
    ...
    t_f: boolean;
    top_status: boolean;
    store: any; indexes: any; indexess: any; language_index_vn: any;
        ...
        this.appservice.get_user_page_parametter_v2(this.page_id, this.type_language).subscribe(
            param => {
                try {
                    ...
                    this.top_status = this.destinationSelectedItems.length > 1 ? true : false;
                    ...
                    if (!environment.production) {
                        console.log('  this.select_category', this.select_category);
                    }
                    if ('site_id' in para) {
    ...
    set_default(defaultOrgId: any) {
        ...
        // const value_index = this.dropdownList.find(item => item.label === this.indexess.shoppers).value;
        ...
        this.appservice.post(data, url).subscribe(res => {
            try {
                if (!environment.production) {
                    ...
                    console.log(this.MenuInput.menu_tree);
                ...
                this.reset_to_zero('total_num_to_enter', 'total_traffic', 'total_avg_time', 'total_passer_by',
                    ...
                    'tt_shopper_on_sh', 'tt_sales_on_sh', 'tt_loyal_visits_nt', 'loyal_purchased', 'items', 'staff'
                );
                let si = 0;
                ...
                if (!environment.production) {
                    console.log(' this.total_avg_time', this.total_avg_time);
                }
                ...
                this.total_avg_time = Number((this.total_avg_time * 60 / si).toFixed(0));
    ...
    exportExcel(): void {
        ...
        // tslint:disable-next-line:max-line-length
        this.appservice.post(data, environment.PERFORMANCE.API.sp_footfall_performance + '_boston_reporting_export_excel').subscribe(fileData => {
            ...
            yAxis: [
                {
                    ...
                    allowDecimals: false, title: {
                        text: this.language_index_vn.people,
                        style: { color: c_.passer_by, fontWeight: 'bold' },
                    },
            ...
            series: [
                {
                    ...
                    visible: selft.check_has_index(this.indexess.transactions),
                    data: transactions,
                }, {
