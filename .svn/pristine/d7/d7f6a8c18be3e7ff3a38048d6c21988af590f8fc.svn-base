...
export class AdminVnLanguage extends AdminLanguage {
    ...
    danh_sach_cau_hinh_nhan_email_bao_cao_dinh_ky = 'Danh sách báo cáo gửi  định kỳ qua email ';
    ...
    quyen_quan_tri_he_thong = 'Quản trị hệ thống';
    quyen_xem_bao_cao = 'Xem báo cáo';
    trang_thai_hoat_dong = 'Hoạt động';
    kich_thuoc_anh_phu_hop = 'Kích thước ảnh phù hợp';
    kich_thuoc_anh_khong_hop_le = 'Kích thước ảnh không hợp lệ';
    Vui_long_nhap_lai_IMEI = 'Vui lòng nhập lại IMEI';
}
