...
@Component({
    selector: 'app-menustorecustomer',
    templateUrl: './menustorecustomer.component.html',
    styleUrls: ['./menustorecustomer.component.scss']
})

export class MenuTreeCustomerStoreComponent implements OnInit {
    menu_tree: any;
    snap_menu_tree: any;
    site_id: any;
