...
// Routing
import { FootfallEffectStoreRoutingModule } from './effect-store-rounting.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallEffectStoreRoutingModule,
    NgSelectModule,
    // Dialog,
    DialogModule,
    DropdownModule,
  ...
  declarations: [
    FootfallEffectStoreComponent,
  ],

})
export class FootfallEffectStoreModule { }
