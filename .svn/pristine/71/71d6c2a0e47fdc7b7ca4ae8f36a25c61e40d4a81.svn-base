        ...
        this.appservice.post(data, environment.API.sp_poc_data_in_out_sum_by_site).subscribe(
            res => {
                try {
                    ...
                    // tslint:disable-next-line:max-line-length
                    this.reset_to_zero('total_num_to_enter', 'total_traffic', 'total_avg_time', 'total_passer_by', 'total_turn_rate', 'total_kids', 'total_shopper_visits', 'total_seconds');
                    let si = 0;
                    res.forEach(element => {
            ...
            yAxis: [
                {
                    ...
                    allowDecimals: false, title: { text: this.indexes.kids_visitors,
                    ...
                    allowDecimals: false, title: { text: this.indexes.traffic_flow,
