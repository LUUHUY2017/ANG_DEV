...
export class FootfallStoreComparisonComponent implements OnInit {
    ...
    defaultModule = 1;
    indexViewBy: number;
    currentPageId = environment.Pages.footfall.store_comparison;
