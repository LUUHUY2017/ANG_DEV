...
// Routing
import { FootfallCustomerMonthlyRoutingModule } from './customer-monthly-routing.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallCustomerMonthlyRoutingModule,
    NgSelectModule,
    DropdownModule,
    DialogModule,
    TreeTableModule,
  ...
  declarations: [
    FootfallCustomerMonthlyComponent,
  ]
})
export class FootfallCustomerMonthlyModule { }
