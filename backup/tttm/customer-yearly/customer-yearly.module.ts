...
// Routing
import { FootfallCustomerYearlyRoutingModule } from './customer-yearly-routing.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallCustomerYearlyRoutingModule,
    NgSelectModule,
    DropdownModule,
    DialogModule,
    TreeTableModule,
  ...
  declarations: [
    FootfallCustomerYearlyComponent,
  ]
})
export class FootfallCustomerYearlyModule { }
