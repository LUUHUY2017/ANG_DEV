export class AdminLanguage {
    ...
    thong_tin_tai_khoan: string;
    quyen: string;
    ngay_kich_hoat: string;
    quyen_quan_tri_he_thong: string;
    quyen_xem_bao_cao: string;
    trang_thai_hoat_dong: string;
    kich_thuoc_anh_phu_hop: string;
    kich_thuoc_anh_khong_hop_le: string;
    Vui_long_nhap_lai_IMEI: string;
