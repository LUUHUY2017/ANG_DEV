export const language_en = {
    ...
    // so_luong_khach_hien_tai: 'Number of shoppers up to now',k
    khach_hang_dang_mua_sam: 'People are here',
    ...
    top_cua_hang_mua_sam: 'Chart of customers at the places',
    tat_ca_bieu_do: 'All',
    gioi_tinh: 'Gender',
    nam_bieu_do: 'Male',
    nu_bieu_do: 'Female',
    ...
    Bao_cao_khach_hang_thang: 'Monthly Traffic Report in',
    Bao_cao_khach_hang_nam: 'Yearly Traffic Report in',
    Bao_cao_khach_hang_theo_loi_vao: 'Traffic Report per entrance',
