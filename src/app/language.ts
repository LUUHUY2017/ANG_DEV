export const language = {
    ...
    khach_hang_dang_mua_sam: 'Khách hàng đang ở trong',
    ...
    slug_login1: 'Chào mừng đến với hệ thống AMMS Analytics Platform. Hệ thống thu thập tất cả các thông tin suốt thời gian trải nghiệm của khách từ khi đặt chân tới khi hoàn thành mua sắm.',
    // tslint:disable-next-line: max-line-length
    slug_login2: 'AMMS Analytics thực hiện việc phân tích nâng cao, cung cấp bức tranh toàn cảnh về hoạt động và hiệu quả hoạt động của từng điểm, toàn hệ thống. Đồng thời đưa ra các cảnh báo theo thời gian thực, giúp Ban lãnh đạo và quản lý đưa ra các quyết định nhanh chóng.',
    ...
    Bao_cao_khach_hang_theo_loi_vao: 'Báo cáo khách hàng theo địa điểm',
    Ban_do_nhiet_heatmap: 'Bản đồ nhiệt',
    // Crescent Mall
    Subtotal: 'Tổng phụ',
    ToTal: 'Tổng',
    In: 'Vào',
    ...
    // Number_of_eletric_counter: 'Khu vực',
    // FLOOR: 'Tầng',
    Time: 'Thời gian',
    Number_of_eletric_counter: 'Mã địa điểm',
    FLOOR: 'Địa điểm',
    Daily: 'Hàng ngày',
    Month: 'Tháng',
    dang_nhap: 'Đăng nhập',
    ...
    To_chuc_chua_duoc_cau_hinh_email_mac_dinh: 'Tổ chức chưa được cấu hình email mặc định',
    Cap_nhat_thanh_cong: 'Cập nhật thông tin thành công',
    Da_co_loi_xay_ra: 'Đã có lỗi xảy ra',
    Khong_the_ket_noi_may_chu: 'Không thể kết nối tới máy chủ.',
    Vui_long_thu_lai: 'Vui lòng thử lại',
    Du_lieu_khong_phu_hop: 'Dữ liệu không phù hợp',
    Du_lieu_khong_thay_doi: 'Dữ liệu không thay đổi',
};
