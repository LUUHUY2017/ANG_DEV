...
@Component({
    ...
    templateUrl: './timeperioddaily.component.html',
    styleUrls: ['./timeperioddaily.component.css']
})

export class TimeperiodDailyComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        $(function () {
            $('#dateReportTempDaily').change(function () {
                self.date_ranger_event(); // Chạy hàm của angular trong jquery
            });
            $('#reportrangedaily').on('apply.daterangepicker').click(function () {
    ...
    get_data(param, time_period_array) {
        ...
        intDateRangePicker_daily_viewchild(start_time_number);
    }
