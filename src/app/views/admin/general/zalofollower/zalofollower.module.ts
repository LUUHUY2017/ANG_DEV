...
// Routing
import { ZaloFollowerRoutingModule } from './zalofollower-routing.module';
import { ZaloFollowerComponent } from './zalofollower.component';
// Ng2-select
...
@NgModule({
    ...
    declarations: [
        ZaloFollowerComponent,
    ],
    providers: [AppService],
})
export class GeneralZaloFollowerModule {
    constructor() { }
}
