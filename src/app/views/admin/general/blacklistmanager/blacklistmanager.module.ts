...
// Routing
import { BlacklistManagerRoutingModule } from './blacklistmanager-routing.module';
import { BlacklistManagerComponent } from './blacklistmanager.component';
// Ng2-select
...
const customNotifierOptions: NotifierOptions = {
    ...
    theme: 'material',
    behaviour: {
        autoHide: 5000, onClick: 'hide', onMouseover: 'pauseAutoHide', showDismissButton: true, stacking: 4
    },
    animations: {
        enabled: true,
...
@NgModule({
    ...
    declarations: [
        BlacklistManagerComponent,
    ],
    providers: [AppService],
})
export class BlacklistManagerModule {
    constructor() { }
}
