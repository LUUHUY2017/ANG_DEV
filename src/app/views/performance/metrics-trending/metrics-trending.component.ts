...
@Component({
    templateUrl: 'metrics-trending.component.html',
    styleUrls: ['metrics-trending.component.scss']
})

export class FootfallMetricsTrendingComponent implements OnInit {
    @ViewChild(StoreReportingFFScheduleComponent) scheduleComponent: StoreReportingFFScheduleComponent;
    defaultModule = 4;
    indexViewBy: number;
    currentPageId = environment.Pages.footfall.performance_metrics_trending;
    ...
    end_date: any;
    time_value = '';
    public page_id = environment.Pages.footfall.performance_metrics_trending;
        ...
        this.appservice.post(data, environment.PERFORMANCE.API.sp_footfall_performance + '_data_by_site').subscribe(
            res => {
                try {
                    ...
                    // }
                    this.tt_sales = Number((this.tt_sales / row).toFixed(0));
                    this.tt_transactions = Number((this.tt_transactions / row).toFixed(0));
                    ...
                    this.tt_missed_sales = Number((this.tt_missed_sales / row).toFixed(0));
            ...
            series: [
                {
                    ...
                    name: this.indexes.nps_index + '(%)', color: c_.npsindex, type: 'spline',
                    yAxis: selft.set_position(this.indexess.nps_index),
