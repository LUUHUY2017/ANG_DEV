...
// Routing
import { ImportPosSaleRoutingModule } from './import_pos_sale-routing.module';
import { ImportPosSaleComponent } from './import_pos_sale.component';
// Ng2-select
...
@NgModule({
  ...
  declarations: [
    ImportPosSaleComponent,
  ],
  providers: [AppService],
})
export class ImportPosSaleModule {
  constructor() { }
}
