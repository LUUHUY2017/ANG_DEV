...
// Routing
import { FootfallEffectMetricsRoutingModule } from './effect-metrics-rounting.module';
import { FootfallEffectMetricsComponent } from './effect-metrics.component';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallEffectMetricsRoutingModule,
    NgSelectModule,
    DropdownModule,
    DialogModule,
  ...
  declarations: [
    ...
    FootfallEffectMetricsComponent,
    // pickuplocationcomponent
    // DataFilterPipe,
  ]
})
export class FootfallEffectMetricsModule { }
