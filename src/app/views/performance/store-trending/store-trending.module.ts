...
// Routing
import { FootfallStoreStrendingRoutingModule } from './store-trending-rounting.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallStoreStrendingRoutingModule,
    NgSelectModule,
    // Dialog,
    DialogModule,
    DropdownModule,
  ...
  declarations: [
    FootfallStoreStrendingComponent,
  ],

})
export class FootfallStoreStrendingModule { }
