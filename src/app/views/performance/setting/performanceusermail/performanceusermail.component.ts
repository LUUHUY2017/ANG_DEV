...
// import viewchild
import { PerformanceMenuComponent } from '../../../viewchild/performancemenu/performancemenu.component';
import { NotifierService } from 'angular-notifier';
import { AdminLanguage } from '../../../../languages';
import { BehaviorSubject } from 'rxjs';

@ViewChild(PerformanceMenuComponent)

@Component({
  templateUrl: './performanceusermail.component.html',
  styleUrls: ['./performanceusermail.component.scss'],
  // chỉnh css angular
  encapsulation: ViewEncapsulation.None
})

export class PerformanceUserMailComponent implements OnInit {
