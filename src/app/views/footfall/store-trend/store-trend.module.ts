...
// Routing
import { FootfallStoreTrendRoutingModule } from './store-trend-rounting.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallStoreTrendRoutingModule,
    NgSelectModule,
    // Dialog,
    DialogModule,
    DropdownModule,
  ...
  declarations: [
    FootfallStoreTrendComponent,

  ],

})
export class FootfallStoreTrendModule { }
