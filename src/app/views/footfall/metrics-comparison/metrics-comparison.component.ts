...
export class FootfallMetricsComparisonComponent implements OnInit {
  ...
  total_num_to_enter = 0; total_num_to_exit = 0; total_traffic = 0; total_avg_time = 0; viewDataBy: string;
  ...
  t_f: boolean; indexes: any; index_value: any; language_index_vn: any;
