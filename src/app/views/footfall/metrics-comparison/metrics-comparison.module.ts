...
// Routing
import { FootfallMetricsComparisonRoutingModule } from './metrics-comparison-rounting.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallMetricsComparisonRoutingModule,
    NgSelectModule,
    DropdownModule,
    DialogModule,
    TreeTableModule,
  ...
  declarations: [
    ...
    FootfallMetricsComparisonComponent,
    // pickuplocationcomponent
    // DataFilterPipe,
  ]
})
export class FootfallMetricsComparisonModule { }
