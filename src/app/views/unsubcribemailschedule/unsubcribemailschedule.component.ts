...
@Component({
  selector: 'app-unsubcribemail',
  templateUrl: 'unsubcribemailschedule.component.html',
  styleUrls: ['./unsubcribemailschedule.component.css']
})
export class UnsubcribeMailComponent implements OnInit {
  messInstance: any;
  ...
  unsubcribeLink() {
    ...
    const url = environment.API.mailReportSchedule.unsubcribeSchedule;
