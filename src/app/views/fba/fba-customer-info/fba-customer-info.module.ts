...
// Routing
import { FbaCustomerInfoRoutingModule } from './fba-customer-info-routing.module';
...
@NgModule({
    ...
    declarations: [
        FbaCustomerInfoComponent,
    ]
})
export class FbaCustomerInfoModule {
    constructor() { }
}
