...
@Component({
  selector: 'app-fba-staff-performance',
  templateUrl: './fba-staff-performance.component.html',
  styleUrls: ['./fba-staff-performance.component.scss', './fba-staff-performance.component.css'],
  // chỉnh css angular
