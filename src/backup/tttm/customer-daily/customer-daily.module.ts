...
// Routing
import { FootfallCustomerDailyRoutingModule } from './customer-daily-routing.module';
...
@NgModule({
  imports: [
    FormsModule,
    ButtonsModule,
    FootfallCustomerDailyRoutingModule,
    NgSelectModule,
    DropdownModule,
    DialogModule,
    TreeTableModule,
  ...
  declarations: [
    FootfallCustomerDailyComponent,
  ]
})
export class FootfallCustomerDailyModule { }
